...
class IdleTest {
	...
	@Test
	@DisplayName("Test that IdleTimer is a proper singleton")
	...
	@Test
	@DisplayName("Test that up() event with memTimer=0 does not transition from IdleTimer")
	...
	@Test
	@DisplayName("Test transition from IdleTimer to ActiveTimer state")
	...
	@Test
	@DisplayName("Test that right() event transitions to SetTimer state")
	void testRight() {
	...
	@Disabled
	@DisplayName("Test left() event (defined in superclass)")
	void testLeft() {
