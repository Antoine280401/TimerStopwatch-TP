...
class TimerTests {
	...
	@Test
	@DisplayName("Verify initial Timer state is IdleTimer")
	...
	@Test
	@DisplayName("Verify AbstractTimer initial state is IdleTimer")
	...
	@Test
	@DisplayName("Verify ActiveTimer initial state is RunningTimer")
	...
	@Test
	@DisplayName("Test history state implementation for Timer mode")
	void testHistoryState() {
		ClockState current = AbstractTimer.Instance();
